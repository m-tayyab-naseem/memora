...
export const metadata: Metadata = {
  title: 'Memora - Memory Vaults',
  description: 'Preserve and share your memories securely with Memora. Create vaults, upload photos and videos, and organize your precious moments together.',
  generator: 'v0.app',
  icons: {
    icon: [
      {
